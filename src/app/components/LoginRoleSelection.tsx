            ...
            <header className="relative w-full py-6 px-8 lg:px-12 z-20 border-b border-black/[0.03] bg-white/40 backdrop-blur-md sticky top-0 transition-all">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        <img src="/logo.png" alt="Ekya School PDI" className="h-16 w-16 object-contain brightness-110" />
                ...
                <div className="max-w-6xl w-full">
                    <div className="text-center mb-16 space-y-4">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/60 border border-slate-100 rounded-full backdrop-blur-sm shadow-sm mb-4">
                            ...
                            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Environment Selection</span>
                        </div>
                        <h2 className="text-5xl lg:text-6xl font-black text-slate-900 tracking-tighter uppercase">
                            Choose Your <span className="text-[#A37FBC]">Path</span>
                        </h2>
                        <p className="text-slate-500 text-lg font-medium max-w-2xl mx-auto tracking-tight">
                            ...
                            return (
                                ...
                                >
                                    <Card className="bg-white/50 border-white/50 backdrop-blur-2xl text-slate-900 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgb(163,127,188,0.12)] transition-all duration-700 group border-none rounded-[2.5rem] overflow-hidden flex flex-col h-full">
                                        ...
                                        <CardHeader className="p-10 relative z-10 flex-1 flex flex-col items-center text-center">
                                            <div className={`${role.bgColor} w-28 h-28 rounded-[2rem] flex items-center justify-center shadow-inner group-hover:scale-110 transition-transform duration-700 border border-white/20 mb-10`}>
                                                <Icon className={`h-12 w-12 ${role.color}`} />
                                            </div>
                                            <CardTitle className="text-2xl font-black text-slate-900 mb-4 tracking-tighter group-hover:text-[#A37FBC] transition-colors duration-500 uppercase">
                                                {role.title}
                                            </CardTitle>
                                            <CardDescription className="text-slate-500 text-sm leading-relaxed font-semibold tracking-tight">
                                                {role.description}
                                            </CardDescription>
                                        </CardHeader>
                                        <div className="p-8 pt-0 relative z-10">
                                            <Button className="w-full bg-white/80 hover:bg-[#A37FBC] text-slate-900 hover:text-white border border-slate-200 group-hover:border-transparent font-black h-14 rounded-2xl transition-all shadow-sm">
                                                Initialize Session
                                            </Button>
                                        </div>
                                    </Card>
